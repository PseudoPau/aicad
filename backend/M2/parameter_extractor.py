"""
backend/M2/parameter_extractor.py

Clean, single-copy JSON-aware extractor for M2.
"""
import json
import re
...
Matches the root extractor behaviour: attempt to parse structured JSON from
the image analysis output and map it to the racking schema used by M3.
"""
import json
import re
from typing import Dict, Any, Optional
